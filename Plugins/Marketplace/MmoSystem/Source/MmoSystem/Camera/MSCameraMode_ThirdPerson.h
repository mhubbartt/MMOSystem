...
#include "MSCameraMode_ThirdPerson.generated.h"
...
class UMSCameraMode_ThirdPerson : public UMSCameraMode
{
	GENERATED_BODY()
...
public:
	...
	TArray<FMSPenetrationAvoidanceFeeler> PenetrationAvoidanceFeelers;
